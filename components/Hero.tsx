  ...
  return (
    ...
    >
      ...
      <div className="mx-auto my-14 flex w-full max-w-3xl flex-col items-center md:my-20 lg:my-28">
        <h1 className="mb-3 max-w-3xl text-wrap text-center font-ledger text-6xl md:text-7xl lg:text-8xl">
          Дом - зеркало вашей души
        </h1>
        <p className="text-center font-jost text-3xl lg:text-4xl">
      ...
      <div className="mx-auto my-8 flex flex-wrap-reverse items-center justify-center lg:my-28">
        <div className="mr-16 flex max-w-md flex-col items-center">
          <h2 className="mb-7 text-center font-ledger text-5xl lg:text-6xl">
            Обо Мне
          </h2>
          <p className="mb-11 text-center font-jost text-2xl md:text-3xl lg:text-2xl">

const Page = () => {
  return (
    <section>
      <div className="mx-auto mt-20 flex h-full w-full flex-col items-center justify-center lg:mt-28">
        <h2 className="mb-4 font-ledger text-4xl">
          Политика конфиденциальности
        </h2>
        <p className="mt-10 pb-20 font-ledger text-xl">
          ...
          безопасности персональных данных, предпринимаемые Макеева Галина
          ...
          Оператор может получить о посетителях веб-сайта https://design-gm.ru/.
          <br />
          ...
          сети интернет по сетевому адресу https://design-gm.ru/.
          <br />
          ...
          <br />
          2.10. Пользователь — любой посетитель веб-сайта https://design-gm.ru/.
          <br />
          ...
          электронных писем Персональные данные
          <br />
          ...
          ph.makflya@mail.ru с пометкой «Актуализация персональных данных».
          <br />
          ...
          на электронный адрес Оператора ph.makflya@mail.ru с пометкой «Отзыв
          ...
          Оператору с помощью электронной почты ph.makflya@mail.ru.
          <br />
          ...
          сети Интернет по адресу https://design-gm.ru/policy.
        </p>
      </div>
    </section>
  );
